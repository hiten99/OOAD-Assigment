#ifndef _CS507_TREE_CALCULATOR_PERFORMANCE_H_
#define _CS507_TREE_CALCULATOR_PERFORMANCE_H_
...
class TreeCalculatorPerformance : public Calculator{
public:

	///constructor
	TreeCalculatorPerformance();
	
	///destructor
	virtual ~TreeCalculatorPerformance();
...
#endif  // !defined _CS507_TREE_CALCULATOR_PERFORMANCE_H_
