#ifndef _CS507_INTOPOSTFIX_FLYWEIGHT_H_
#define _CS507_INTOPOSTFIX_FLYWEIGHT_H_
#include <iostream>
#include <sstream>
#include <string>
...
class InToPostfix_Flyweight : public Calculator{
public:
	// constructor
	InToPostfix_Flyweight();
	// destructor
	virtual ~InToPostfix_Flyweight();
...
#endif  // !defined _CS507_INTOPOSTFIX_FLYWEIGHT_H_